    ...
    return (
      ...
      >
        <div className="absolute inset-0 pointer-events-none"
          style={{ background: 'radial-gradient(ellipse at 15% 50%, rgba(219, 176, 88,0.04), transparent 55%)' }}
        />
        ...
        <div className="flex-1 min-w-0">
          <p data-role="labelTiny" className="typo-label-xs mb-1" style={{ color: '#dbb058', opacity: 0.40 }}>
            Void Trader
          </p>
          <h3 data-role="hero" className="typo-hero orokin-etched" style={{ color: '#e3e8de' }}>
        ...
        <div className="text-right flex-shrink-0">
          ...
          <p data-role="labelTiny" className="typo-label-xs mt-1" style={{ color: '#dbb058', opacity: 0.30 }}>
            not yet on station
          </p>
        </div>
      </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        borderColor: 'rgba(219, 176, 88,0.20)',
        borderTop:   '2px solid rgba(219, 176, 88,0.35)',
      }}
    >
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse at 10% 50%, rgba(219, 176, 88,0.06), transparent 55%)' }}
      />
      <span className="absolute top-0 left-0 w-4 h-4 pointer-events-none"
        style={{ borderTop: '1px solid rgba(219, 176, 88,0.45)', borderLeft: '1px solid rgba(219, 176, 88,0.45)' }}
      />

      {/* Header */}
      <div className="flex items-center justify-between mb-5">
        <div>
          <p data-role="labelTiny" className="typo-label-xs mb-0.5" style={{ color: '#dbb058', opacity: 0.40 }}>
            Void Trader · On Station
          </p>
          <h3 data-role="hero" className="typo-hero orokin-etched" style={{ color: '#dbb058' }}>
            {trader.character.toUpperCase()}
          </h3>
          ...
          {trader.inventory.slice(0, 12).map((item, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2">
                <span className="font-mono text-[9px] tabular-nums font-bold" style={{ color: '#DBB058' }}>
                  {item.ducats}
